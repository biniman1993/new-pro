...
const CategoryFilters = ({ 
  ...
  .map(([filterType, options]) => (
    <div key={filterType} className="border-b border-gray-100 pb-6 last:border-0">
            <button
                    ...
                    >
                      ...
                      {filterType === 'availability' && (
                        <span className={cn(
                          ...
                          option === 'In stock' ? "bg-green-100 text-green-700" :
                          option === 'Out of stock' ? "bg-red-100 text-red-700" :
